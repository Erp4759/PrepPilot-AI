...
class SkillSettingsDialog extends StatefulWidget {
...
class _SkillSettingsDialogState extends State<SkillSettingsDialog> {
...
class SkillSettingChip extends StatelessWidget {
  const SkillSettingChip({
    super.key,
    required this.label,
