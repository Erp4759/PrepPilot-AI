...
class WritingEssayStructuresScreen extends StatefulWidget{
  ...
  @override
  State<WritingEssayStructuresScreen> createState() => _WritingEssayStructuresScreenState();
}

class _WritingEssayStructuresScreenState extends State<WritingEssayStructuresScreen>{
